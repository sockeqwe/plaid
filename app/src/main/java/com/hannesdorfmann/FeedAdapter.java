...
public class FeedAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
  ...
  public FeedAdapter(Activity hostActivity, int columns, boolean pocketInstalled) {
    ...
    TypedArray placeholderColors =
        hostActivity.getResources().obtainTypedArray(R.array.loading_placeholders);
  ...
  private void bindDesignerNewsStory(final Story story, final DesignerNewsStoryHolder holder) {
    ...
    holder.comments.setOnClickListener(new View.OnClickListener() {
      @Override public void onClick(View commentsView) {
    ...
    if (pocketIsInstalled) {
      ...
      holder.pocket.setOnClickListener(new View.OnClickListener() {
        @Override public void onClick(final View view) {
          ...
          PropertyValuesHolder pvhTitleUp =
          ...
          Animator titleMoveFadeOut =
              ObjectAnimator.ofPropertyValuesHolder(holder.title, pvhTitleUp, pvhTitleFade);

          Animator pocketMoveUp =
              ObjectAnimator.ofFloat(pocketButton, View.TRANSLATION_X, View.TRANSLATION_Y,
          ...
          Animator pocketScaleUp =
              ObjectAnimator.ofPropertyValuesHolder(pocketButton, pvhPocketScaleUpX,
                  pvhPocketScaleUpY);
          ObjectAnimator pocketFadeUp =
              ObjectAnimator.ofInt(pocketButton, ViewUtils.IMAGE_ALPHA, 255);
          ...
          PropertyValuesHolder pvhTitleMoveUp =
              PropertyValuesHolder.ofFloat(View.TRANSLATION_Y, 0f);
          PropertyValuesHolder pvhTitleFadeUp = PropertyValuesHolder.ofFloat(View.ALPHA, 1f);
          Animator titleMoveFadeIn =
              ObjectAnimator.ofPropertyValuesHolder(holder.title, pvhTitleMoveUp, pvhTitleFadeUp);
          ...
          Animator pvhPocketScaleDown =
              ObjectAnimator.ofPropertyValuesHolder(pocketButton, pvhPocketScaleDownX,
                  pvhPocketScaleDownY);
          ObjectAnimator pocketFadeDown =
              ObjectAnimator.ofInt(pocketButton, ViewUtils.IMAGE_ALPHA, 138);
  ...
  private void bindProductHuntPostView(final Post item, ProductHuntStoryHolder holder) {
    ...
    holder.comments.setOnClickListener(new View.OnClickListener() {
      @Override public void onClick(View v) {
        CustomTabActivityHelper.openCustomTab(host, new CustomTabsIntent.Builder().setToolbarColor(
                ContextCompat.getColor(host, R.color.product_hunt)).build(),
